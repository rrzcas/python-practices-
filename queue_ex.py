...
for number in numbers:
 q. put (number) #put array into queue 
 # q.get method in queue - always gets you the next item in queue


class Solution :
    def SumFx (self , q:queue.Queue )-> int:
        sum1=0
    ...
    def MultFx (self , q:queue.Queue )-> int:
        msum1=1
    ...
    def SumOdd_Fx (self , q:queue.Queue )-> int:
        sosum1=0
        #Oddnum=[]
    ...
    def Sum3rd_Fx (self , q:queue.Queue )-> int:
        sum3=0
        diff3rd=0
        while not q.empty():
